...
Pouring is an action applying to one touchable thing. Filling is an action applying to two touchable things.

Understand “pour [something] out” as pouring. Understand "pour out [something]" as pouring. Understand “pour [something] into [something]” as filling. Understand "pour [something] in [something]" as filling.
